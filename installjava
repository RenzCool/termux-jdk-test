...
then
	...
	aarch64)
		archaname="aarch64"; tag="v17.0.8" ;;
	arm64)
		archaname="aarch64"; tag="v17.0.8" ;;
	armhf)
		archaname="arm"; tag="v17.0.8" ;;
	armv7l)
		archaname="arm"; tag="v17.0.8" ;;
	arm)
		archaname="arm"; tag="v17.0.8" ;;
	*)
	...
	#Actual installation
	ee "\e[32m[*] \e[34mDownloading JDK-17 (~173Mb) for ${archaname}...  🕛This will take some time, so better make a coffee.🕛"
	wget https://github.com/RenzCool/termux-jdk-test/releases/download/${tag}/jdk-17.0.8_linux${archaname}_bin.tar.gz -q

	ee "\e[32m[*] \e[34mMoving JDK to system..."
	mv jdk-17.0.8_linux${archaname}_bin.tar.gz $PREFIX/share

	ee "\e[32m[*] \e[34mExtracting JDK..."
	cd $PREFIX/share
	tar -xhf jdk-17.0.8_linux${archaname}_bin.tar.gz
	...
	rm -rf $PREFIX/share/jdk-17.0.8_linux${archaname}_bin.tar.gz
